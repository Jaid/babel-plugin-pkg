...
const debug = require("debug")("babel-plugin-pkg")
 ...
 * @example
 * import babelPluginPkg from "babel-plugin-pkg"
 * let result = babelPluginPkg(["a", "b"])
 * result = {a: null, b: null}
 * @example
 * import babelPluginPkg from "babel-plugin-pkg"
 * let result = babelPluginPkg(["a", "b"], "value")
 * result = {a: "value", b: "value"}
 * @example
 * import babelPluginPkg from "babel-plugin-pkg"
 * let result = babelPluginPkg(["a", "b"], (key, index) => `value for ${key} #${index + 1}`)
 ...
 * import {parallel} from "babel-plugin-pkg"
